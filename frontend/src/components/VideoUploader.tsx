...
test_mode_code = """import React, { useState, useEffect, useRef } from 'react';
import { 
...
with open('/mnt/data/VideoUploader.tsx', 'w') as f:
    f.write(video_uploader_code)

with open('/mnt/data/test-mode.tsx', 'w') as f:
    f.write(test_mode_code)
