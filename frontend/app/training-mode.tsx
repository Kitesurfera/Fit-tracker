...
export default function AnalyticsScreen() {
  ...
  const renderBodyMap = () => {
    ...
    const topMuscles = Object.entries(heat)
      ...
      return (
        <View style={styles.emptyCard}>
          ...
          <Text style={{ textAlign: 'center', color: colors.textSecondary, marginTop: 12, fontSize: 15 }}>
            No hay datos suficientes en los últimos 14 días para mostrar el mapa muscular.
          </Text>
        </View>
      );
    }
    ...
    return (
      <View style={{ paddingBottom: 100 }}>
        ...
        <View style={[styles.topMusclesCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <Text style={{ color: colors.textPrimary, fontWeight: '800', fontSize: 16, marginBottom: 15 }}>Top Músculos</Text>
